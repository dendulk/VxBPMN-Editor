 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.wfmc.org/2008/XPDL2.1}ConstraintGroup" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "ConstraintGroups")
public class ConstraintGroups {

    @XmlElement(name = "ConstraintGroup")
    protected List<ConstraintGroup> constraintGroup;
     ...
     * {@link ConstraintGroup }
     * 
     * 
     */
    public List<ConstraintGroup> getConstraintGroup() {
        if (constraintGroup == null) {
            constraintGroup = new ArrayList<ConstraintGroup>();
        }
